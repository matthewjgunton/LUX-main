...
extension SwipeableCardViewContainer {
    ...
    func didEndSwipe(onView view: SwipeableView) {
        ...
        if (view.dragDirection == SwipeDirection.right) {
            dataSource.cardSwiped()
            /*
            Alamofire.request(urlString, method: .post, parameters: [Event()],encoding: JSONEncoding.default, headers: nil).responseJSON {
                response in
